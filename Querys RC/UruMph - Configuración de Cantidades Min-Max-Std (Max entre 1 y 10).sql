...
select bv.pmfbatchsize, bv.PMFYIELDPCT, * from bomversion bv
inner join INVENTTABLE i
on i.DATAAREAID = bv.DATAAREAID
and i.ITEMID = bv.ITEMID
where bv.dataareaid = '120' 
and active = 1
and APPROVED = 1
and (todate = '1900-01-01' or todate > GETUTCDATE())
and i.ITEMTYPE = 3 -- Fórmula
and PMFBATCHSIZE < 10
